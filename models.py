...
class Profile(models.Model):
    ...
    image=models.ImageField(upload_to='website/images',default=r"D:\\final year project\\food recapp\minor\media\website\images\avtar.png")
...
class Strength(models.Model):
    ...
    Beginner=models.IntegerField(max_length=50,default=0)
    Novice=models.IntegerField(max_length=50,default=0)
    Intermediate=models.IntegerField(max_length=50,default=0)
    Advanced=models.IntegerField(max_length=50,default=0)
    Elite=models.IntegerField(max_length=50,default=0)