...
def Recommend(request):
    if request.user.is_authenticated:   
        class Recommender:
            ...
            def k_neighbor(self,inputs,feature_df,dataframe,k):
                ...
                for i in list(indices):
                    df_results = df_results.concat(dataframe.loc[i])
            ...
            def recommend(self,user_id):
                ...
                features = []
                features.concat(profile['Nutrient'].values[0])
        ...
        profiles = pd.read_csv(r'D:\\final year project\\food recapp\\minor\\website\\csvfile\\user_Profiles.csv') # profiles of all users
        recent_activity = pd.read_csv(r'D:\\final year project\\food recapp\\minor\\website\\csvfile\\recent_activity.csv') # recent activities of current user (meals liked,rated,searched,Purchased)
        dataset = pd.read_csv(r'D:\\final year project\\food recapp\\minor\\website\\dataset.csv') # main dataset
